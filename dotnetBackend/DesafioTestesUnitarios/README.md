...
> [Link repositório do desafio](https://github.com/digitalinnovationone/trilha-net-testes-unitarios-desafio)
...
![Métodos Swagger](.github/projeto.png)


## Resultado :

Print do terminal após execução dos testes : 
![Resultado dos testes](.github/reultadoTstes.png)