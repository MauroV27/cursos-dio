...
def criar_usuario(usuarios):
    ...
    if cpf.isdigit() == False:
        print("\n@@@ CPF inválido, fluxo de criação de conta encerrado! @@@")
        return None
...
def filtrar_usuario(cpf:str, usuarios:dict):
...
def get_valid_value(input_text:str) -> float:
    if len(input_text) > 0 and input_text.capitalize() != "NAN":
        try:
